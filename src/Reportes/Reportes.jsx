...
const Reportes = () => {
  ...
  useEffect(() => {
    const subcolecciones = ["sabanas", "toallas", "fundas de almohada", "duvets", "tapetes", "toallas de mano", "otros"];
        ...
        <table className="table-auto w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="px-4 py-2 text-center font-semibold">Comentario</th>
            </tr>
          </thead>
          <tbody>
            {movimientosConComentarios.map((movimiento) => (
              <tr key={movimiento.id} className="border-b">
                ...
                <td className="px-4 py-2 text-center">
                  {new Date(movimiento.timestamp.seconds * 1000).toLocaleString("es-ES", {
                    year: "numeric",
                    month: "2-digit",
                    day: "2-digit",
                    hour: "2-digit",
