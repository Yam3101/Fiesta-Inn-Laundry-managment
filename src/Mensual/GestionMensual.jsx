...
const GestionMensual = () => {
  ...
  const colores = [
    "#FF0000", "#FF7F00", "#FFD700", "#008000", "#00BFFF", "#1E90FF",
    "#8A2BE2", "#D2691E", "#008000", "#0000FF", "#FFA500", "#FF0000"
  ];
    ...
    <div className="overflow-x-hidden w-screen h-screen bg-gray-70">
      ...
      <div className="container mx-auto mt-8">
        <h2 className="text-3xl font-semibold mb-4 bg-gray-200 p-4 rounded flex items-center justify-between">
          ...
          <div style={{ width: "15px", height: "40px", backgroundColor: "#FF0000" }}></div>
        </h2>
        ...
        <h3 className="text-xl font-semibold mb-4">Movimientos del Año {anioSeleccionado}</h3>
        {meses.map((mes, index) => (
          <div key={index} className="mb-4">
            ...
            >
              ...
              <div style={{ width: "20px", height: "40px", backgroundColor: colores[index] }}></div>
            </button>
            {mesSeleccionado === index && (
              <div className="mt-2 bg-white shadow-md rounded-md p-4">
                {movimientosPorMes[index] ? (
                  ...
                  <p className="p-4 text-center">No hay movimientos en este mes.</p>
                )}
              </div>
            )}
          </div>
