...
const Duvets = () => {
    ...
    useEffect(() => {
        const q = query(collection(db, 'lavanderia', 'duvets', 'movimientos'), orderBy('timestamp', 'asc'));
    ...
    const handleGuardarEdicion = async () => {
        if (currentMovimiento && newCantidad !== '') {
            const movimientoRef = doc(db, 'lavanderia', 'duvets', 'movimientos', currentMovimiento.id);
    ...
    const confirmarBorrar = async () => {
        if (movimientoToDelete) {
            const movimientoRef = doc(db, 'lavanderia', 'duvets', 'movimientos', movimientoToDelete.id);
